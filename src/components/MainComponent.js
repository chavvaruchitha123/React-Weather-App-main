...
// // //       const url = `https://api.openweathermap.org/data/2.5/weather?query=${query}&key=${apiKey}`;
...
// // //       const apiKey = "12a15b4f2a34aee821f0f79cebc08698";
// // //       const url = `https://api.openweathermap.org/data/2.5/weather?query=Rabat&key=${apiKey}`;
